...
OBJECTS_LIST = work_with_text.o diffur.o diff_arrates.o diff_dump.o diff_optimiz.o diff_read_inf.o main.o 
OBJECTS_DIR  = objects/
SOURCE_DIR   = source/

diff: $(addprefix $(OBJECTS_DIR), $(OBJECTS_LIST))
	@echo ----------------------------------------------------
	g++ $(FLAGS) $(addprefix $(OBJECTS_DIR), $(OBJECTS_LIST)) -g -o diff 
	@echo ----------------------------------------------------
